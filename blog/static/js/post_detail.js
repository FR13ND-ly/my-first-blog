...
function select_one_variant(variant){
    ...
    for (i = 0; i<variants.length; i++){
        variants[i].className = "collection-item light-blue-text text-darken-2";
...
function select_multi_variant(variant) {
    ...
    if (variant.className == "collection-item light-blue-text text-darken-2"){
        variant.className = "collection-item active light-blue darken-2";
        variant_input.name = 'variant';
    }
    else {
        variant.className = "collection-item light-blue-text text-darken-2";
